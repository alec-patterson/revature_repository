...
public class RoomManager {
	...
	public void init() {
		 ...
		 */
		family.exits.put("north", bedroom1);
		family.exits.put("east", loft);
		family.exits.put("south", garage);
		
		garage.exits.put("north", family);
		garage.exits.put("west", kitchen);
		
		kitchen.exits.put("north", pantry);
		kitchen.exits.put("east", garage);

		
		pantry.exits.put("north", diningRoom);
		pantry.exits.put("south", kitchen);
		
		diningRoom.exits.put("south", pantry);
		diningRoom.exits.put("west", backyard);
		
		backyard.exits.put("east", diningRoom);
		
		bedroom1.exits.put("east", bathroom1);
		bedroom1.exits.put("south", family);
		
		driveway.exits.put("north", garage);
	
		bathroom1.exits.put("west", bedroom1);
		
		loft.exits.put("north", bedroom2);
		loft.exits.put("east", bedroom3);
		loft.exits.put("south", laundry);
		loft.exits.put("west", family);
		
		bedroom2.exits.put("east", bathroom2);
		bedroom2.exits.put("south", loft);
		
		bedroom3.exits.put("north", bathroom2);
		bedroom3.exits.put("west", loft);
		
		bathroom2.exits.put("west", bedroom2);
		bathroom2.exits.put("south", bedroom3);
		
		masterBedroom.exits.put("south", masterBathroom);
		masterBedroom.exits.put("west", balcony);
		
		masterBathroom.exits.put("north", masterBedroom);
		masterBathroom.exits.put("east", laundry);
		
		balcony.exits.put("east", masterBedroom);
		balcony.exits.put("west", backyard);
		
		laundry.exits.put("north", loft);
		laundry.exits.put("west", masterBathroom);
		...
		backyard.addItems(new Swimming(backyard, diningRoom));
